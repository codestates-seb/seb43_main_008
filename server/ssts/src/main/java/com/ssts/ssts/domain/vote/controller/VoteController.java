package com.ssts.ssts.domain.vote.controller;
...
//    투표 하기 (사용자가 투표한 이후의 찬반 표수를 응답값으로 넘기면 좋을 것 같음)
    ...
    @PutMapping("/{vote_id}/{votes}") //TODO 토큰시에 켜기
    ...
    public ApiResponse<VoteResponse> patchVote(@NotNull @PathVariable("vote_id") Long voteId, @PathVariable("votes") @Max(1)int isAgree){ //TODO 토큰 테스트시에 주석 풀기
        ...
        VoteResponse response = voteService.attendVote(voteId, isAgree); //TODO 토큰시에 주석풀기
