...
public class FollowService {
    ...
    public void following(String nickName) {
        ...
        if(following.getId()==follower.getId() || following.getMemberStatus()== MemberStatus.WITHDRAW){
    ...
    public void unfollowing(String nickName){
        ...
        if(unfollowing.getId()==follower.getId() || unfollowing.getMemberStatus()== MemberStatus.WITHDRAW){
            throw new BusinessLogicException(ExceptionCode.FOLLOW_NOT_AVAILABLE);
