...
public class MemberMyPageResponseDto {
    ...
    public static MemberMyPageResponseDto of(String nickName, String image, String introduce, List<Long> seriesIdList) {
        ...
        memberMyPageResponseDto.setSeriesIdList(seriesIdList);
