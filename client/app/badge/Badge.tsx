...
//     alt: "쓰또 로고",
//   });
//   const [mainText, setMainText] = useState("가입 축하 뱃지 획득!");
//   const [subText, setSubText] = useState(
//     "10%를 달성하여 아래 뱃지를 획득해보세요!"
//   );
//   const isAcquiredArray = badgeLists.map((badge) => badge.isAcquired);
...
//           isAcquired={badgeList.isAcquired}
//         />
//       </MainContainer>
//       <BadgeDetail
//         setSelectedImageDetail={setSelectedImageDetail}
...
//         <MainText>{mainText}</MainText>
//         <SubText>{subText}</SubText>
//         <BadgeCircle image={selectedImage} isAcquired={isAcquired} />
//       </MainContainer>
//       <BadgeDetail
