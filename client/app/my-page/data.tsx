...
export const data: Data = {
  ...
  seriesIdList: [
    ...
    },
    {
      ...
      isPublic: true,
      isEditable: true, // 이거 왜 true ? 
      isActive: false,
      voteStatus: "SERIES_QUITP",
      voteCount: 1,
      voteResult: true,
    ...
    },
    {
      ...
      isPublic: true,
      isEditable: true,
      isActive: true, // 이거 왜 true ? 
      voteStatus: "SERIES_QUITP", //마감 시간이 지나도 더 쓴다고 선택하기 전까지 해당 상태는 quit
      voteCount: 1,
      voteResult: false,
      image: "https://cdn.startuptoday.kr/news/photo/202205/43885_28909_5023.jpg",
    },
    {
      ...
      voteStatus: "SERIES_ACTIVE", //사용자가 더 쓴다고 선택시 해당 Status가 투표전으로 바뀜
      voteCount: 1,
      voteResult: false,
      image: "https://cdn.startuptoday.kr/news/photo/202205/43885_28909_5023.jpg",
    },
