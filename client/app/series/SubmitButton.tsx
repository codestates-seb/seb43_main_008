...
// eexport default function SubmitButton({ isPhotoUploaded, isTextWritten, onCreate, onClose }: SubmitButtonProps) {
  ...
  return (
    <>
      <SubmitButtonStyled
        type="submit"
        onClick={handleCreated}
        disabled={!(isPhotoUploaded && isTextWritten)} // 이미지가 업로드되지 않았거나 텍스트가 입력되지 않은 경우 버튼을 비활성화
      >
        작성 완료
      </SubmitButtonStyled>
      {showInformation && (
